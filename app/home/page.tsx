    ...
    return (
      ...
      <div className="relative h-screen w-full">
        ...
        <div className="absolute inset-0 flex flex-col items-start justify-center p-4 md:p-16">
          ...
          <button className="mt-6 px-6 py-3 bg-slate-600 text-white font-semibold rounded hover:bg-black transition">
            Get Started
          </button>
        </div>
        <div className="py-1 bg-slate-700 text-center align-center  text-white">Footer (HomeWork class-6) <br />
                | Ansharah Khan | GIAIC
                </div>
      </div>
      </>
