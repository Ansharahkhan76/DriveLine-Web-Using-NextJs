    ...
    return(
      ...
      <div className=" bg-gray-100 p-8 rounded-lg shadow-lg w-full max-w-md">
        ...
        <form>
          ...
          <Link href="/thankuhPage"><button type="submit" className="w-full bg-slate-700 text-white py-2 px-4 rounded-lg hover:bg-black transition-colors">
            Place Your Order
          </button></Link>
        </form>
      </div>
    </div>
    <div className="py-1 text-center bg-slate-700 text-white">Footer (HomeWork class-6) <br />
                | Ansharah Khan | GIAIC
                </div>
        </>
    )
